...
local UI_SOUNDS = {
	...
	d = "rbxassetid://133565712308985", -- ButtonClick (swapped 2026-07-24: analyzed all 26 source wavs by peak/RMS/duration -- the original "d" sample was quiet and long (-28dB peak, 1.5s), read as soft not punchy. Letter "l"'s sample is the punchiest short transient in the pack (-13dB peak, 0.64s) -- reused here for a snappier click. "l" itself still plays unchanged for Success.
