	...
	onDecorate = function(zoneName, config)
		...
		local success, err = pcall(function()
			...
			for _, sample in ipairs(samples) do
				local decoType = ScatterEngine.pickDecoration(config.selectedDecorations, zoneProfile.decorationWeights)
				if decoType then
