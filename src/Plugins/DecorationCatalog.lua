...
DecorationCatalog.floating_crystal = {
	...
	parts = {
		partDef(
			...
			Vector3.new(0, 1.0, 0),
			{ rotation = Vector3.new(0, 0, 15) }
		),
		partDef(
			"Wedge",
			Vector3.new(0.35, 1.0, 0.35),
			Color3.fromRGB(200, 182, 255),
			Vector3.new(0.15, 0.9, 0.1),
			{ rotation = Vector3.new(0, 45, -10) }
		),
		partDef(
			"Wedge",
			Vector3.new(0.3, 0.8, 0.3),
			Color3.fromRGB(173, 216, 230),
			Vector3.new(-0.1, 0.7, -0.15),
			{ rotation = Vector3.new(15, 90, 5) }
		),
	},
	lights = {
...
DecorationCatalog.crystal_spire = {
	...
	parts = {
		...
		partDef(
			...
			{ rotation = Vector3.new(0, 30, 8) }
		),
		partDef(
			"Wedge",
			Vector3.new(0.3, 1.2, 0.3),
			Color3.fromRGB(255, 182, 193),
			Vector3.new(-0.05, 0.6, -0.08),
			{ rotation = Vector3.new(10, 60, -5) }
		),
	},
	lights = {
