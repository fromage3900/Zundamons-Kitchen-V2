...
ScatterConfig.biomes = {
	zunda_forest = {
		...
		node_types = {
			...
			ZundaLeaf = {
				resourceType = "ZundaLeaf",
				density = 0.12,
				spacing = 30,
				variants = { "ZundaLeaf_Default" },
				variantWeights = { 1.0 },
				scaleRange = { 0.5, 0.8 },
				yOffset = 0,
				harvestEffect = "rbxassetid://241685484",
			...
			SweetPea = {
				resourceType = "SweetPea",
				density = 0.15,
				spacing = 22,
				variants = { "SweetPea_Default" },
				variantWeights = { 1.0 },
				scaleRange = { 0.7, 1.0 },
				yOffset = -0.1,
				harvestEffect = "rbxassetid://241685484",
			...
			PeaFlower = {
				resourceType = "PeaFlower",
				density = 0.10,
				spacing = 28,
				variants = { "PeaFlower_Default" },
				variantWeights = { 1.0 },
				scaleRange = { 0.6, 0.9 },
				yOffset = 0,
				harvestEffect = "rbxassetid://241685484",
			...
			SaltedPeaBouquet = {
				resourceType = "SaltedPeaBouquet",
				density = 0.05,
				spacing = 35,
				variants = { "SaltedPeaBouquet_Default" },
				variantWeights = { 1.0 },
				scaleRange = { 1.0, 1.2 },
				yOffset = 0,
				harvestEffect = "rbxassetid://241685484",
