...
SkyConfig.keyframes = {
	...
	{
		0,
		Color3.fromRGB(25, 18, 55),
		Color3.fromRGB(14, 10, 35),
		Color3.fromRGB(40, 28, 80),
		Color3.fromRGB(22, 16, 48),
		Color3.fromRGB(28, 20, 55),
		75,
		550,
		0.48,
		Color3.fromRGB(65, 45, 130),
		-0.50,
		-4,
	},
	{
		2,
		Color3.fromRGB(28, 20, 62),
		Color3.fromRGB(16, 12, 40),
		Color3.fromRGB(45, 32, 90),
		Color3.fromRGB(25, 18, 55),
		Color3.fromRGB(32, 22, 62),
		80,
		600,
		0.46,
		Color3.fromRGB(75, 52, 145),
		-0.46,
		-3,
	},
	{
		4.5,
		Color3.fromRGB(52, 34, 92),
		Color3.fromRGB(38, 26, 72),
		Color3.fromRGB(100, 55, 142),
		Color3.fromRGB(65, 38, 108),
		Color3.fromRGB(95, 65, 155),
		90,
		680,
		0.42,
		Color3.fromRGB(130, 75, 178),
		-0.34,
		-2,
	},
	{
		6, -- Dawn: purple-pink sunrise
		Color3.fromRGB(180, 110, 142),
		Color3.fromRGB(232, 150, 160),
		Color3.fromRGB(252, 175, 168),
		Color3.fromRGB(175, 155, 210),
		Color3.fromRGB(248, 185, 182),
		110,
		750,
		0.36,
		Color3.fromRGB(248, 170, 172),
		0.04,
		2,
	},
	{
		7,
		Color3.fromRGB(195, 132, 148),
		Color3.fromRGB(248, 195, 192),
		Color3.fromRGB(250, 212, 192),
		Color3.fromRGB(185, 180, 225),
		Color3.fromRGB(250, 208, 202),
		115,
		800,
		0.34,
		Color3.fromRGB(250, 202, 192),
		0.06,
		3,
	},
	{
		...
		Color3.fromRGB(242, 234, 248),
		Color3.fromRGB(242, 234, 232),
		Color3.fromRGB(200, 200, 238),
		Color3.fromRGB(222, 220, 242),
		150,
		1100,
		0.30,
		Color3.fromRGB(205, 210, 242),
		0.08,
		6,
	},
	{
		11,
		Color3.fromRGB(175, 168, 205),
		Color3.fromRGB(248, 242, 250),
		Color3.fromRGB(240, 235, 235),
		Color3.fromRGB(205, 208, 238),
		Color3.fromRGB(228, 226, 245),
		180,
		1300,
		0.28,
		Color3.fromRGB(195, 208, 242),
		0.10,
		8,
	},
	{
		12,
		Color3.fromRGB(180, 174, 210),
		Color3.fromRGB(250, 246, 250),
		Color3.fromRGB(242, 238, 238),
		Color3.fromRGB(210, 212, 240),
		Color3.fromRGB(230, 230, 250),
		200,
		1400,
		0.26,
		Color3.fromRGB(190, 208, 242),
		0.12,
		9,
	},
	{
		15,
		Color3.fromRGB(182, 164, 182),
		Color3.fromRGB(250, 234, 240),
		Color3.fromRGB(250, 232, 222),
		Color3.fromRGB(202, 205, 235),
		Color3.fromRGB(242, 225, 228),
		180,
		1250,
		0.30,
		Color3.fromRGB(218, 212, 240),
		0.10,
		6,
	},
	{
		17, -- Dusk: warm pink-purple
		Color3.fromRGB(205, 135, 145),
		Color3.fromRGB(250, 192, 180),
		Color3.fromRGB(250, 192, 168),
		Color3.fromRGB(190, 165, 208),
		Color3.fromRGB(250, 192, 188),
		145,
		1000,
		0.36,
		Color3.fromRGB(250, 178, 172),
		0.06,
		4,
	},
	{
		18.5,
		Color3.fromRGB(165, 95, 115),
		Color3.fromRGB(235, 150, 152),
		Color3.fromRGB(250, 155, 142),
		Color3.fromRGB(155, 125, 175),
		Color3.fromRGB(248, 155, 152),
		120,
		820,
		0.40,
		Color3.fromRGB(248, 152, 148),
		0.02,
		2,
	},
	{
		20,
		Color3.fromRGB(92, 60, 115),
		Color3.fromRGB(112, 90, 148),
		Color3.fromRGB(175, 125, 175),
		Color3.fromRGB(102, 82, 148),
		Color3.fromRGB(150, 112, 178),
		110,
		780,
		0.44,
		Color3.fromRGB(165, 118, 188),
		-0.14,
		-1,
	},
	{
		22,
		Color3.fromRGB(35, 28, 78),
		Color3.fromRGB(20, 16, 50),
		Color3.fromRGB(55, 45, 115),
		Color3.fromRGB(35, 28, 72),
		Color3.fromRGB(42, 32, 82),
		88,
		660,
		0.46,
		Color3.fromRGB(88, 70, 165),
		-0.36,
		-3,
	},
	{
...
SkyConfig.weather_types = {
	clear = {
		...
		color_correction = {
			...
			contrast = 0.02,
			saturation = 0.16,
			tint = Color3.fromRGB(232, 225, 245),
		},
	},
	cloudy = {
		display_name = "Cloudy",
		...
		color_correction = {
			...
			contrast = 0.03,
			saturation = 0.15,
			tint = Color3.fromRGB(222, 220, 242),
		},
	},
	cherry_blossom = {
		...
		color_correction = {
			...
			contrast = 0.01,
			saturation = 0.18,
			tint = Color3.fromRGB(240, 224, 238),
		},
	},
	rain = {
		display_name = "Rain",
		...
		color_correction = {
			...
			contrast = 0.04,
			saturation = 0.14,
			tint = Color3.fromRGB(210, 214, 238),
		},
	},
	snow = {
		display_name = "Snow",
		...
		color_correction = {
			...
			contrast = 0.02,
			saturation = 0.16,
			tint = Color3.fromRGB(230, 234, 246),
		},
	},
	aurora = {
		display_name = "Aurora",
		...
		color_correction = {
			...
			contrast = 0.04,
			saturation = 0.15,
			tint = Color3.fromRGB(210, 206, 245),
		},
	},
	storm = {
		...
		color_correction = {
			...
			contrast = 0.08,
			saturation = 0.13,
			tint = Color3.fromRGB(178, 184, 218),
		},
	},
	fog = {
		display_name = "Mist",
		...
		particle_size = 8,
		particle_rate = 15,
		particle_lifetime = 12,
		particle_speed = 2,
		atmosphere_haze = 3.6,
		atmosphere_density_mult = 2.5,
		fog_mult = 0.40,
		...
		color_correction = {
			...
			contrast = 0.02,
			saturation = 0.14,
			tint = Color3.fromRGB(220, 218, 238),
		},
	},
}
