...
local ZONES_INFO = {
	...
	{ emoji = "🍳", name = "Kitchen Garden", desc = "Farming, cooking & the main gameplay loop.", pos = "(9, 4, -41)" },
	{
		emoji = "🗻",
		name = "Eastern Peaks",
		desc = "Elevated highlands near the east pyramid.",
		pos = "(130, 23, 73)",
	},
	{
		emoji = "✨",
		name = "Mystic Heights",
		desc = "High cliffs with the best stargazing spot!",
		pos = "(149, 35, -195)",
	},
	{ emoji = "⛩", name = "Hilltop Shrine", desc = "Ancient shrine atop the eastern hill.", pos = "(85, 30, 120)" },
	{
		emoji = "🏛",
		name = "Ancient Ruins",
		desc = "Northwestern ruins with mysterious energy.",
		pos = "(-20, 12, -150)",
	},
}
...
panel.Name = "Panel"
panel.Size = UDim2.new(0, 600, 0, 580)
...
searchBox.Position = UDim2.new(0, 16, 0, 96)
...
tabBar.Size = UDim2.new(0.48, -8, 0, 34)
tabBar.Position = UDim2.new(0.52, 8, 0, 96)
...
scroll.Name = "Content"
scroll.Size = UDim2.new(1, -32, 0, 410)
scroll.Position = UDim2.new(0, 16, 0, 142)
scroll.BackgroundColor3 = Color3.fromRGB(248, 240, 230)
...
local function buildRecipeCard(r, idx, owned)
	...
	nm.Size = UDim2.new(1, -170, 0, 24)
	nm.Position = UDim2.new(0, 68, 0, 10)
	...
	ingLbl.Size = UDim2.new(1, -170, 0, 38)
	ingLbl.Position = UDim2.new(0, 68, 0, 34)
	ingLbl.BackgroundTransparency = 1
	ingLbl.Text = "Needs: " .. table.concat(ingParts, ", ")
	ingLbl.Font = Enum.Font.Gotham
	ingLbl.TextSize = 12
	ingLbl.TextColor3 = C.sub
	ingLbl.TextXAlignment = Enum.TextXAlignment.Left
	ingLbl.TextWrapped = true

	local badge = Instance.new("Frame", card)
	badge.Size = UDim2.new(0, 68, 0, 28)
	badge.Position = UDim2.new(1, -76, 0, 12)
	badge.BackgroundColor3 = Color3.fromRGB(255, 242, 180)
	...
	bLbl.TextSize = 14
	bLbl.TextColor3 = Color3.fromRGB(150, 110, 20)

	if owned then
		local ownedBadge = Instance.new("Frame", card)
		ownedBadge.Size = UDim2.new(0, 60, 0, 22)
		ownedBadge.Position = UDim2.new(1, -68, 0, 48)
		ownedBadge.BackgroundColor3 = C.owned
		...
		oLbl.Size = UDim2.new(1, 0, 1, 0)
		oLbl.BackgroundTransparency = 1
		oLbl.Text = "✅ " .. owned
		oLbl.Font = Enum.Font.GothamBold
		oLbl.TextSize = 11
		oLbl.TextColor3 = Color3.fromRGB(50, 110, 50)
	end
end
...
local function buildItemCard(item, idx)
	...
	local nm = Instance.new("TextLabel", card)
	nm.Size = UDim2.new(0, 200, 0, 24)
	nm.Position = UDim2.new(0, 50, 0, 8)
	nm.BackgroundTransparency = 1
	nm.Text = item.name
	nm.Font = Enum.Font.FredokaOne
	nm.TextSize = 15
	...
	countLbl.Position = UDim2.new(1, -150, 0, 0)
	countLbl.BackgroundTransparency = 1
	countLbl.Text = "0x"
	countLbl.Font = Enum.Font.GothamBold
	countLbl.TextSize = 13
	countLbl.TextColor3 = catColor2
...
local function buildZoneCard(z, idx)
	...
	em.Position = UDim2.new(0, 10, 0.5, -26)
	em.BackgroundColor3 = Color3.fromRGB(235, 225, 210)
	em.Text = z.emoji
	...
	pos.Size = UDim2.new(0, 100, 1, 0)
	pos.Position = UDim2.new(1, -110, 0, 0)
	pos.BackgroundTransparency = 1
	pos.Text = z.pos
	pos.Font = Enum.Font.Code
	pos.TextSize = 11
	pos.TextColor3 = Color3.fromRGB(160, 150, 140)
...
tabRecipes.MouseButton1Click:Connect(function()
	...
	UIHelper.spawnSparkles(
		panel,
		pos.X + tabRecipes.AbsoluteSize.X / 2,
		pos.Y + tabRecipes.AbsoluteSize.Y / 2,
...
tabItems.MouseButton1Click:Connect(function()
	...
	UIHelper.spawnSparkles(
		panel,
		pos.X + tabItems.AbsoluteSize.X / 2,
		pos.Y + tabItems.AbsoluteSize.Y / 2,
		Color3.fromRGB(255, 255, 255),
		3
	)
end)
tabZones.MouseButton1Click:Connect(function()
	...
	UIHelper.spawnSparkles(
		panel,
		pos.X + tabZones.AbsoluteSize.X / 2,
		pos.Y + tabZones.AbsoluteSize.Y / 2,
		Color3.fromRGB(255, 255, 255),
		3
	)
end)
...
UIRouter.register("compendium", nil, function()
	shell.close()
end)
