...
local gui = require(RS.ConfigurationFiles.ClientGuiBootstrap).createScreenGui(player, "TutorialGui", 150)
...
titleLbl.Name = "Title"
titleLbl.Size = UDim2.new(1, -40, 0, 48)
titleLbl.Position = UDim2.new(0, 20, 0, 16)
...
descLbl.Name = "Desc"
descLbl.Size = UDim2.new(1, -48, 0, 72)
descLbl.Position = UDim2.new(0, 24, 0, 68)
...
navFrame.Name = "Nav"
navFrame.Size = UDim2.new(1, -32, 0, 44)
navFrame.Position = UDim2.new(0, 16, 1, -52)
...
local function buildDots()
	for i = 1, #STEPS do
		...
		dot.Position = UDim2.new(0.5, -(#STEPS * 14 / 2) + (i - 1) * 28, 0.5, -5)
...
buttonFrame.Size = UDim2.new(1, -32, 0, 36)
buttonFrame.Position = UDim2.new(0, 16, 1, -100)
buttonFrame.BackgroundTransparency = 1
buttonFrame.BorderSizePixel = 0

local skipBtn = Instance.new("TextButton", buttonFrame)
skipBtn.Size = UDim2.new(0.48, -4, 1, 0)
skipBtn.Position = UDim2.new(0, 0, 0, 0)
skipBtn.BackgroundColor3 = Color3.fromRGB(210, 200, 185)
skipBtn.Text = "Skip ✕"
skipBtn.Font = Enum.Font.GothamBold
skipBtn.TextSize = 14
skipBtn.TextColor3 = Color3.fromRGB(100, 75, 55)
skipBtn.BorderSizePixel = 0
Instance.new("UICorner", skipBtn).CornerRadius = UDim.new(0, 10)

local nextBtn = Instance.new("TextButton", buttonFrame)
nextBtn.Size = UDim2.new(0.48, -4, 1, 0)
nextBtn.Position = UDim2.new(0.52, 4, 0, 0)
nextBtn.BackgroundColor3 = C.button
nextBtn.Text = "Next →"
