...
ost.Thickness = 2
ost.Color = UIConfig.COLORS.PeaAccent
ost.Transparency = 0.2

-- Title bar inside
local titleBar = Instance.new("TextLabel", outer)
titleBar.Size = UDim2.new(1, -8, 0, 20)
titleBar.Position = UDim2.new(0, 4, 0, 3)
titleBar.BackgroundTransparency = 1
titleBar.Text = "🗺  Mini Map 🗺"
...
canvas.Name = "Canvas"
canvas.Size = UDim2.new(1, -8, 1, -28)
canvas.Position = UDim2.new(0, 4, 0, 24)
...
for _, t in ipairs(TP_ZONES) do
	...
	dot.BackgroundColor3 = Color3.fromRGB(100, 80, 180)
...
pin.BackgroundColor3 = Color3.fromRGB(255, 80, 80)
...
pinRing.Size = UDim2.new(1, 4, 1, 4)
pinRing.AnchorPoint = Vector2.new(0.5, 0.5)
pinRing.Position = UDim2.new(0.5, 0, 0.5, 0)
pinRing.BackgroundTransparency = 1
pinRing.BorderSizePixel = 0
local ringStroke = Instance.new("UIStroke", pinRing)
...
arrow.BackgroundColor3 = Color3.fromRGB(255, 200, 80)
arrow.BorderSizePixel = 0
arrow.ZIndex = 5

-- ── COMPANION DOT ─────────────────────────────────────────────────────────
local compDot = Instance.new("Frame", canvas)
compDot.Name = "CompanionDot"
compDot.Size = UDim2.new(0, 7, 0, 7)
compDot.AnchorPoint = Vector2.new(0.5, 0.5)
compDot.BackgroundColor3 = Color3.fromRGB(100, 220, 180)
compDot.BorderSizePixel = 0
compDot.ZIndex = 4
...
timeStrip.Size = UDim2.new(1, -8, 0, 18)
timeStrip.Position = UDim2.new(0, 4, 1, -20)
timeStrip.BackgroundTransparency = 1
local timeLbl = Instance.new("TextLabel", timeStrip)
timeLbl.Name = "TimeLbl"
timeLbl.Size = UDim2.new(0.5, 0, 1, 0)
timeLbl.BackgroundTransparency = 1
timeLbl.Text = "--:--"
timeLbl.Font = Enum.Font.GothamBold
timeLbl.TextSize = 11
timeLbl.TextColor3 = Color3.fromRGB(200, 195, 220)
timeLbl.TextXAlignment = Enum.TextXAlignment.Left
local weatherLbl = Instance.new("TextLabel", timeStrip)
weatherLbl.Name = "WeatherLbl"
weatherLbl.Size = UDim2.new(0.5, 0, 1, 0)
weatherLbl.Position = UDim2.new(0.5, 0, 0, 0)
weatherLbl.BackgroundTransparency = 1
weatherLbl.Text = "☀"
weatherLbl.Font = Enum.Font.GothamBold
weatherLbl.TextSize = 11
weatherLbl.TextColor3 = Color3.fromRGB(200, 195, 220)
weatherLbl.TextXAlignment = Enum.TextXAlignment.Right

-- ── UPDATE LOOP ──────────────────────────────────────────────────────────
local function fmtH(h)
	local hr = math.floor(h)
	local mn = math.floor((h - hr) * 60)
...
task.spawn(function()
	...
	while true do
		...
		local icons =
			{ clear = "☀", cloudy = "☁", rain = "🌧", snow = "❄", cherry_blossom = "🌸", aurora = "🌌" }
