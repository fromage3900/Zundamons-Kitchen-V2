...
pStroke.Color = Color3.fromRGB(180, 130, 220)
pStroke.Thickness = 2
...
resetBtn.MouseButton1Click:Connect(function()
	...
	for action, r in pairs(rowMap) do
		r.btn.Text = keyName(binds[action])
	end
...
local function closePanel()
	...
	isOpen = false
	local t =
		TweenService:Create(panel, TweenInfo.new(0.18, Enum.EasingStyle.Quad), { Size = UDim2.new(0, 440, 0, 500) })
